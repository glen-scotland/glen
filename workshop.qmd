...
## Workshop document
Here is the link to the [workshop document](https://drive.google.com/file/d/1kH-3da3LCoGV2H29_xVzvY0VyPYKZTi6/view?usp=sharing). Alongside the abstracts, the document outlines the topics for the afternoon discussion session, with each talk mapped to corresponding themes and a set of prompt questions. As this session is intended to be highly interactive, it would be greatly appreciated if you could take a quick look at Section 5 before the workshop.
