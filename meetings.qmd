...
## Paper discussion
**Reference:** Jiang, J., Richards, J., Huser, R., & Bolin, D. (2025). [Separation-based causal discovery for extremes](https://drive.google.com/file/d/1kThOmSl_RthhnuH2uHt-_wHndAXHr0ZR/view?usp=drive_link). *arXiv preprint arXiv:2505.08008*.
...
::: {.callout-tip collapse="true" appearance="simple" icon=false}
# <span style="color: rgb(25,188,156)">10/06/26 13:00-15:00</span>  Session 5: Revision lecture + wrap up
